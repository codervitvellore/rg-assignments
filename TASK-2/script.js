...
function updateTransaction(id, payee, amount, reason) {
    // Task5: Find the transaction with the given 'id' in the 'transactions' array.
...
function deleteTransaction(id) {
    // Task6: Find the index of the transaction with the given 'id' in the 'transactions' array and remove it using 'splice'.
